...
import {
  ...
  Icon, Flex, HStack, Text, useToken
} from '@chakra-ui/react';
import { motion } from 'framer-motion';
import { FaTools, FaPlus, FaCalendarAlt, FaWrench, FaClock } from 'react-icons/fa';
import { getHostellerMaintenanceRequests, createMaintenanceRequest } from '../services/api';

const MotionBox = motion(Box);

const HostellerMaintenanceTab = () => {
    ...
    <Box>
      ...
      {requests.length === 0 ? (
        <MotionBox
          ...
          textAlign="center"
        >
          <Icon as={FaWrench} color="gold.400" boxSize={10} mb={4} />
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  <Th color="gold.500" fontWeight="600" letterSpacing="0.5px" textTransform="uppercase" fontSize="xs">Scheduled Date</Th>
                  ...
                  <Tr key={request._id} _hover={{ bg: "whiteAlpha.50" }}>
                    ...
                    <Td>
                      {request.scheduledDate ? (
                        <HStack spacing={1}>
                          <Icon as={FaClock} color="gold.400" boxSize={3} />
                          <Text>{new Date(request.scheduledDate).toLocaleDateString()}</Text>
                        </HStack>
                      ) : (
                        '-'
                      )}
            ...
            <form onSubmit={handleSubmit}>
              <FormControl mb={4} isRequired>
                ...
                <Input
                  ...
                  placeholder="Brief title of your maintenance request"
...
export default HostellerMaintenanceTab;